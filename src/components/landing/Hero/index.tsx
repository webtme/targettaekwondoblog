...
function Name() {
  return (
    ...
    >
      ...
      >
        <Translate id="homepage.hero.name">RALive</Translate>
      </span>
      ...
      <div className={styles.intro}>
        ...
        <motion.p custom={2} initial="hidden" animate="visible" variants={variants} className="max-lg:px-4">
          <Translate id="homepage.hero.text">
            在這裡我會分享各類技術堆疊所遇到問題與解決方案，帶你了解最新的技術堆疊以及實際開發中如何應用，並希望我的開發經驗對你有所啟發。
          </Translate>
        </motion.p>
        ...
        <motion.div className="mt-4 flex gap-2" custom={4} initial="hidden" animate="visible" variants={variants}>
          ...
          >
            <a href={'/about'} className="font-semibold">
              <Translate id="hompage.hero.introduce">關於我們</Translate>
            </a>
          </MovingButton>
        </motion.div>
      </div>
